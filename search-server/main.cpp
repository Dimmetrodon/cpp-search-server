...
int main() {
    ...
    const auto dictionary = GenerateDictionary(generator, 10, 2);
    const auto documents = GenerateQueries(generator, dictionary, 10, 2);

    const string query = GenerateQuery(generator, dictionary, 10, 0.1);
